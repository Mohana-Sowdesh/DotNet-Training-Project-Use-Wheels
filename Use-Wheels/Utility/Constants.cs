...
namespace Use_Wheels.Utility
{
	public static class Constants
	{
		...
		public static class UnblackSeller
		{
			...
			public const string USER_NOT_BLACKED = "Cannot unblack an active user!!";
		}
		...
		public static class CarConstants
		{
			...
			public const int CAR_CACHE_EXPIRATION = 1800;
			public const string DATE_OF_REG_ERROR = "Car date of registration cannot be in the future";
			public const string CAR_CREATED_SUCCESSFULLY = " Car created successfully!!";
        }
